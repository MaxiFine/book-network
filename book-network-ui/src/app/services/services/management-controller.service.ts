...
import { delete$ } from '../fn/management-controller/delete';
import { Delete$Params } from '../fn/management-controller/delete';
import { get } from '../fn/management-controller/get';
import { Get$Params } from '../fn/management-controller/get';
import { post } from '../fn/management-controller/post';
import { Post$Params } from '../fn/management-controller/post';
import { put } from '../fn/management-controller/put';
import { Put$Params } from '../fn/management-controller/put';

@Injectable({ providedIn: 'root' })
export class ManagementControllerService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `get()` */
  static readonly GetPath = '/api/v1/manager';
  ...
  static readonly PutPath = '/api/v1/manager';
  ...
  static readonly PostPath = '/api/v1/manager';
  ...
  static readonly DeletePath = '/api/v1/manager';
